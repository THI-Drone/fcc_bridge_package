...
const inline auto ALL_STATES =
    testing::Values<INTERNAL_STATE>(
        INTERNAL_STATE::ERROR,
        INTERNAL_STATE::STARTING_UP,
        INTERNAL_STATE::ROS_SET_UP,
        INTERNAL_STATE::MAVSDK_SET_UP,
        INTERNAL_STATE::WAITING_FOR_ARM,
...
const inline auto AIRBORNE_STATES =
    testing::Values<INTERNAL_STATE>(
        INTERNAL_STATE::TAKING_OFF,
        INTERNAL_STATE::WAITING_FOR_COMMAND,
        INTERNAL_STATE::FLYING_MISSION,
...
const inline auto ON_GROUND_STATES =
    testing::Values<INTERNAL_STATE>(
        INTERNAL_STATE::STARTING_UP,
        INTERNAL_STATE::ROS_SET_UP,
        INTERNAL_STATE::MAVSDK_SET_UP,
...
const inline auto ERROR_STATE = testing::Values<INTERNAL_STATE>(INTERNAL_STATE::ERROR);
